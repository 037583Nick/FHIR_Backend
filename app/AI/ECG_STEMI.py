...
class ECG_STEMIPreprocessor(BasePreprocessor):
    ...
    def get_results(self, lang="en"):
        ...
        # Check if data from ER & Acute STEMI
        # forER_Alert = bool((self.LocationName in ['急診-4', '急診-1', '急診-3', '急診-2', '急診', 'ER']) & (label == 'STEMI'))
        forER_Alert = False
        # bool(
        #     (
        #         self.LocationName
        #         in ["急診-4", "急診-1", "急診-3", "急診-2", "急診", "ER", "急診-5", "急診-6"]
        #     )
        #     & (value > 0.5)
        # )
    ...
    def load_image(self, fn):
        ...
        # self.LocationName = xd["RestingECG"]["TestDemographics"]["LocationName"]
